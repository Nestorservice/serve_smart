...
<div class="text-center py-5">
    ...
    <a href="<?= url('/') ?>" class="btn btn-primary" style="background: var(--gradient); border: none; border-radius: 50px; padding: 0.75rem 2rem;">
    ...
    <div class="col-lg-8 mx-auto">
        ...
        <div class="card border-0 shadow-lg mb-4" style="border-radius: 20px; overflow: hidden;">
            <div class="card-body p-0">
                <div class="p-4 text-white text-center" style="background: var(--gradient);">
                    <h4 class="mb-2">Commande #<?= e($order['order_number'] ?? $order['id']) ?></h4>
        ...
        <div class="card border-0 shadow-sm mb-4" style="border-radius: 20px;">
            <div class="card-body p-4">
                <h5 class="fw-bold mb-4">
                    <i class="bi bi-signpost-2 me-2" style="color: var(--primary)"></i>
                    Progression
                </h5>
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 20px;">
            <div class="card-body p-4">
                ...
                <?php if ($tableNumber): ?>
                <div class="d-flex align-items-center mb-4 p-3 rounded" style="background: rgba(102, 126, 234, 0.1);">
                    <i class="bi bi-pin-map fs-4 me-3" style="color: var(--primary)"></i>
                    <div>
                        <small class="text-muted d-block">Votre table</small>
                        <strong class="fs-5">Table <?= e($tableNumber) ?></strong>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="d-flex align-items-center py-3 border-bottom">
                    <div class="d-flex align-items-center justify-content-center rounded me-3" 
                        ...
                        <span class="fw-bold" style="color: var(--primary)"><?= $item['quantity'] ?>x</span>
                    </div>
                    <div class="flex-grow-1">
                        <h6 class="mb-0"><?= e($item['product_name'] ?? 'Produit') ?></h6>
                        <small class="text-muted"><?= Helpers::formatPrice($item['unit_price'] ?? 0) ?> / unité</small>
                    </div>
        ...
        <div class="text-center mt-4">
            <a href="<?= url('client/menu' . ($tableNumber ? '?table=' . $tableNumber : '')) ?>" class="btn btn-outline-primary btn-lg" style="border-radius: 50px; padding: 0.75rem 2rem;">
